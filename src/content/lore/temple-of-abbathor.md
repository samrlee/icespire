...
transformed the surviving priests into the **ochre jellies** that blocked the
dig. There was no known way to change them back. All three are dead now.

## The layout

The temple loops back on itself. Every hidden passage the dwarves built here
eventually comes home to the main chamber — Dax proved it by opening a
seamless stretch of wall at the end of a black corridor and stepping straight
back out beside the altars.

- **Main chamber** — four pillars and the altars. One pillar base hid the
  gemstone coffer.
- **The rubble hallway** (north secret door) — where the last jelly died, and
  where a **third secret door** sits in the wall beyond it. Rut, in rat form,
  found it and could not shift it; it opens easily for anyone with a shoulder.
- **The eastern passage** — beyond that third door, running straight to a
  **cave-in floor to ceiling**, with a plain door on either side.
  - **The crypt:** a skeleton half-buried under fallen stone, wearing
    Abbathor's holy symbol. Hamish took it.
  - **The vestry:** two dwarves laid out in red vestments (rotted armor,
    spider-filled robes), an empty stone font dry for centuries, and a secret
    door behind it onto the **sleeping chamber** — three bed frames, a body
    crushed under collapsed ceiling, and a longsword that never rotted.
...
- A holy symbol taken from the crypt skeleton — a small jeweled dagger on a
  silver chain — reads, in Dwarvish runes, *"Greed is good."* Hamish carries
  it.
- A coffer of rubies, emeralds, and topaz was hidden in a pillar base. Was.
- The entrance hall is a **funnel**: attackers come through one and two at a
  time, and the pillars inside give archers full cover. Seven orcs learned
  this in Session 6.
