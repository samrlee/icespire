...
export const submaps: Record<string, SubmapEntry> = {
  ...
  gnomengarde: {
    ...
    width: 1960,
    height: 1248,
    scaleNote: '1 square = 5 feet · Drag to pan; scroll or pinch to zoom',
    legend: [
      { label: 'The grotto pool', note: 'mushroom farm on the isles' },
      { label: 'Rope bridge & waterfall', note: 'goop-covered; crossed anyway' },
      { label: 'Throne room', note: 'hidden passage, peephole, paranoid king', interior: true },
      { label: 'Royal chambers', note: 'where Queen Gnerkli was found tied up', interior: true },
      { label: 'The ballista workshop', note: 'Facktoré field-tested it on Thom', interior: true },
      { label: 'Storage room', note: 'two mimics, both dealt with', interior: true },
      { label: 'The blade room', note: 'the party disabled the blade trap in Session 3', interior: true },
    ],
  },
  'dwarven-excavation': {
    ...
    legend: [
      ...
      { label: 'Entrance hall', note: 'the funnel — seven orcs came through it one and two at a time', interior: true },
      { label: 'Main chamber', note: 'the jelly fight; a pillar base hid the gemstone coffer', interior: true },
      { label: 'Rubble hallway', note: 'behind the north secret door — the last jelly, and a third secret door beyond it', interior: true },
      { label: 'South passage', note: 'ends in rubble, beside a dead dwarf and the temple ledger', interior: true },
      { label: 'The crypt', note: "a skeleton wearing Abbathor's holy symbol — “Greed is good”", interior: true },
      { label: 'The vestry', note: 'two dwarves in red vestments, a font dry for centuries, and a fourth secret door', interior: true },
      { label: 'Sleeping chamber', note: 'three bed frames, a crushed body, and a longsword that never rotted', interior: true },
      { label: 'The cave-in', note: 'burrowed through in Session 7', interior: true },
      { label: 'The hidden chamber', note: 'two shattered statues; the last offering taken in Session 7', interior: true },
    ],
  },
  'umbrage-hill': {
