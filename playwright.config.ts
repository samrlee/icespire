...
export default defineConfig({
  ...
  projects: [
    { name: 'webkit-desktop-navigation', testMatch: '**/{navigation,entities,portraits,reading-print,current-state,npc-directory,search-results,recap-mentions,core-completion}.spec.ts', use: { browserName: 'webkit', viewport: { width: 1280, height: 800 } } },
